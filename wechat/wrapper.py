...
class WeChatHandler(object):
    ...
    def reply_text(self, content: object) -> object:
        """
    ...
    def is_event_click(self, event_keys: object) -> object:
...
class WeChatView(BaseView):
    ...
    def handle_wechat_msg(self):
        ...
        return self.handle_wechat_msg_helper(msg)

    def handle_wechat_msg_helper(self, msg):
        msg = self.parse_msg_xml_raw(msg)
    ...
    def parse_msg_xml_raw(self, msg):
        return self.parse_msg_xml(ET.fromstring(msg))
