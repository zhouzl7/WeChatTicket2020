...
class User(models.Model):
    ...
    to_active = models.BooleanField(default=False)
    system_user = models.OneToOneField(SystemUser, on_delete=models.CASCADE, null=True)
...
class Ticket(models.Model):
    email = models.EmailField(max_length=32, db_index=True, default='@')
